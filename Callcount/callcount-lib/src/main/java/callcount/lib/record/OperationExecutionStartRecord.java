 ...
 */
public final class OperationExecutionStartRecord extends AbstractMonitoringRecord implements IMonitoringRecord.Factory {
	 ...
	 */
	public OperationExecutionStartRecord(final String operationSignature, final String sessionId, final long traceId, final long tin,
	...
	public OperationExecutionStartRecord(final Object[] values) { // NOPMD (values stored directly)
